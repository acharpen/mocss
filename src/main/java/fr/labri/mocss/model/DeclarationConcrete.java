...
public class DeclarationConcrete extends Declaration implements ElementWithPosition {

    private final Position position;

    public DeclarationConcrete(Property property, ValueConcrete value, Position position) {
